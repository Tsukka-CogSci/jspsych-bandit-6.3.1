...
jsPsych.plugins["bandit"] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 42%; left: 0; right: 0'><img src='"+trial.image1+"' id='jspsych-bandit-stim'></img><img src='"+trial.image2+"' id='jspsych-bandit-stim'></img><img src='"+trial.image3+"' id='jspsych-bandit-stim'></img></div>";
    ...
    function no_response(){
      jsPsych.pluginAPI.cancelKeyboardResponse(keyboardListener);
      html_str = "<div style='position: absolute; height: 20%; width: 100%; margin-left: auto; margin-right: auto; top: 30%; left: 0; right: 0'>response time out. pless space key to continue.</div>";
      display_element.innerHTML = html_str;
